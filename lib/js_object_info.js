...
JavaScriptObjectInfo.prototype.getNotUsedInheritedProperties = function () {
    return this._notUsedInheritedProperties;
};

JavaScriptObjectInfo.prototype.setNotUsedInheritedProperties = function (notUsedInheritedProperties) {
    this._notUsedInheritedProperties = notUsedInheritedProperties;
};

JavaScriptObjectInfo.prototype.getUsedProperties = function () {
    return this._usedProperties;
};

JavaScriptObjectInfo.prototype.setUsedProperties = function (usedProperties) {
    this._usedProperties = usedProperties;
};

JavaScriptObjectInfo.prototype.getLineNumber = function () {
    return this.lineNumber;
};

JavaScriptObjectInfo.prototype.setLineNumber = function (lineNumber) {
    this.lineNumber = lineNumber;
};

JavaScriptObjectInfo.prototype.getJsFileName = function () {
    return this._jsFileName;
};

JavaScriptObjectInfo.prototype.setJsFileName = function (jsFileName) {
    this._jsFileName = jsFileName;
};

JavaScriptObjectIno.prototype.equals = function (o) {
...
JavaScriptObjectInfo.hashCode = function () {
    return 1;
}
